...
public class GooglePic {
   ...
   public static void main(String[] args) throws IOException {
	   GooglePic googlePic = new GooglePic();
   ...
   private void test1() throws IOException {
        ...
        */
       Thumbnails.of("D:/test.jpg").size(200, 300).toFile("C:/image_200x300.jpg");
   ...
   private void test2() throws IOException {
        ...
        * scale(比例)
        */
       Thumbnails.of("D:/spic.jpg").scale(1f).outputQuality(0.8f).toFile("D:/spic9.jpg");
       Thumbnails.of("D:/spic.jpg").scale(1f).outputQuality(0.6f).toFile("D:/spic11.jpg");
   }
